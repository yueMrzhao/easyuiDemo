...
var td=$("<td rowspan=\""+_5b.frozenColumns.length+"\"><div class=\"datagrid-header-rownumber\">"+(_5b.rownumbersTitle!=null && _5b.rownumbersTitle!=''?_5b.rownumbersTitle:"")+"</div></td>");
if($("tr",t).length==0){
...
if(opts.pagination){
$.extend(_1a9,{page:opts.pageNumber||1,pageSize:opts.pageSize});//将原来的rows参数改成pageSize参数
}
/*if(opts.sortName){*/ //自定义改造参数设置
$.extend(_1a9,{sortName:(opts.sortName!=null && opts.sortName!="")?opts.sortName:"",sortOrder:(opts.sortOrder!=null && opts.sortOrder !="")?opts.sortOrder:""});
/*}*/
//新增一个whereparams 数组参数
$.extend(_1a9,{whereparams:(opts.whereparams!=null && opts.whereparams!="")?opts.whereparams :[]});
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",emptyMsg:"",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:"",sortOrder:"",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rownumberWidth:30,editorHeight:24,headerEvents:{mouseover:_82(true),mouseout:_82(false),click:_86,dblclick:_8d,contextmenu:_93},rowEvents:{mouseover:_96(true),mouseout:_96(false),click:_9e,dblclick:_a9,contextmenu:_ae},rowStyler:function(_251,_252){
},loader:function(_253,_254,_255){
var opts=$(this).datagrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:{'paramsGrid':JSON.stringify(_253)},dataType:"json",success:function(data){
_254(data);
},error:function(){
